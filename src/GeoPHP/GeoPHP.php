...
use GeoPHP\Adapters\EWKB;
use GeoPHP\Adapters\EWKT;
use GeoPHP\Adapters\GeoHash;
use GeoPHP\Adapters\GeoJSON;
use GeoPHP\Adapters\GeoRSS;
use GeoPHP\Adapters\GoogleGeocode;
use GeoPHP\Adapters\GPX;
use GeoPHP\Adapters\KML;
use GeoPHP\Adapters\WKB;
use GeoPHP\Adapters\WKT;
